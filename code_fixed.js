...
onEvent("Star1", "click", function( ) {
  setImageURL("Star1", "Screenshot-2025-09-24-10.14.30-AM.png");
  setText("txtwhy", "We see that you left 1 star. How could we do better?");
  setImageURL("Star2", "Screenshot-2025-09-24-1.23.09-PM.png");
  setImageURL("Star3", "Screenshot-2025-09-24-1.23.09-PM.png");
  setImageURL("Star4", "Screenshot-2025-09-24-1.23.09-PM.png");
  setImageURL("star5", "Screenshot-2025-09-24-1.23.09-PM.png");
  setPosition("review", 0, 300, 350, 100);
  setText("skip", "Submit");
});
onEvent("Star2", "click", function( ) {
  setImageURL("Star1", "Screenshot-2025-09-24-10.14.30-AM.png");
  setImageURL("Star2", "Screenshot-2025-09-24-10.14.30-AM.png");
  setText("txtwhy", "We see that you left 2 stars. How could we do better?");
  setImageURL("Star3", "Screenshot-2025-09-24-1.23.09-PM.png");
  setImageURL("Star4", "Screenshot-2025-09-24-1.23.09-PM.png");
  setImageURL("star5", "Screenshot-2025-09-24-1.23.09-PM.png");
  setPosition("review", 0, 300, 350, 100);
...
onEvent("Star3", "click", function( ) {
  setImageURL("Star1", "Screenshot-2025-09-24-10.14.30-AM.png");
  setImageURL("Star2", "Screenshot-2025-09-24-10.14.30-AM.png");
  setImageURL("Star3", "Screenshot-2025-09-24-10.14.30-AM.png");
  setText("txtwhy", "We see that you left 3 stars. How could we do better?");
  setImageURL("Star4", "Screenshot-2025-09-24-1.23.09-PM.png");
  setImageURL("star5", "Screenshot-2025-09-24-1.23.09-PM.png");
  setPosition("review", 0, 300, 350, 100);
  setText("skip", "Submit");
...
onEvent("Star4", "click", function( ) {
  ...
  setImageURL("Star2", "Screenshot-2025-09-24-10.14.30-AM.png");
  setImageURL("Star3", "Screenshot-2025-09-24-10.14.30-AM.png");
  setImageURL("Star4", "Screenshot-2025-09-24-10.14.30-AM.png");
...
onEvent("star5", "click", function( ) {
  ...
  setImageURL("Star3", "Screenshot-2025-09-24-10.14.30-AM.png");
  setImageURL("Star4", "Screenshot-2025-09-24-10.14.30-AM.png");
  setImageURL("star5", "Screenshot-2025-09-24-10.14.30-AM.png");
...
onEvent("resultarrow", "click", function( ) {
  ...
  setText("quizreuslt7", "Question 7: ✅ You answered Yes");
  setText("quizreuslt8", "Question 8: ✅ You answered Yes");
  setText("quizreuslt9", "Question 9: ✅ You answered Yes");
  setText("quizreuslt10", "Question 10: ✅ You answered No");
});
